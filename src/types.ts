...
export type Exam = { id: string; name: string; status?: AcademicStatus }
export type Subject = { id: string; examId?: string; parentId?: string | null; name: string; code?: string; description?: string; type?: 'subject' | 'topic' | 'subtopic' | 'mixed'; status?: AcademicStatus; order?: number }
export type Chapter = { id: string; subjectId: string; name: string; status?: AcademicStatus; order?: number }
